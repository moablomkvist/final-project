...
export const GlossaryPage = () => {
  return (
    //When we have time we're gonna transform this to a json.
    <>
      <Header>
        <NavigationContainer>
      ...
      <LetterSection>
        ...
        <WordCardContainer>
          ...
          <WordExplanation>
            Alpacaull är den naturliga fibern från alpacan och den har en
            liknande struktur som fibrer från fårull. Dess mjukhet beror på
            fiberns lilla diameter, i likhet med merino-ull. Det är en mjuk,
            hållbar, lyxig och silkeslen naturlig fiber. Alpacagarn tovas inte
            så lätt och blir inte så nopprig. Det kan vara lätt eller tungt
            beroende på hur det är spunnet.
          </WordExplanation>
        </WordCardContainer>
        ...
        <WordCardContainer>
          ...
          <WordExplanation>
            Den sida av plagget som vänder inåt, alltså den sidan som är minst
            synlig.
          </WordExplanation>
        </WordCardContainer>
        ...
        <WordCardContainer>
          ...
          <WordExplanation>
            När man stickar eller virkar i den bakre maskbågen sticks nålen i
            den bågen på maskan som är längst bort från dig (avsett om det är
            den räta eller aviga sidan). Som stickteknik kallas det även att
            sticka vridet rät eller vridet avigt.
          </WordExplanation>
        </WordCardContainer>
        ...
        <WordCardContainer>
          ...
          <WordExplanation>
            Den del av plagget som täcker baksidan av kroppen. På en tröja är
            det den del som täcker ryggen.
          </WordExplanation>
        </WordCardContainer>
        ...
        <WordCardContainer>
          ...
          <WordExplanation>
            Chainette-garn har en väldigt unik konstruktion där tråden är
            konstruerad som en kedja med ihålig kärna. Plagg som stickas i dessa
            garn blir väldigt elastiska och får en känsla av plysch.
            Chainette-garn ger också fina definierade maskor vilket passar extra
            bra till t.ex. flätor.
          </WordExplanation>
        </WordCardContainer>
        ...
        <WordCardContainer>
          ...
          <WordExplanation>
            En stickteknik där man minskar på ena sidan och ökar på den andra
            sidan för att skapa en diagonal effekt.
          </WordExplanation>
        </WordCardContainer>
        ...
        <WordCardContainer>
          ...
          <WordExplanation>
            Ett diagram är en visuell presentation av mönstret du ska
            sticka/virka och hur det kommer att se ut. Det består av symboler
            eller ett rutnät med symboler och det upprepas vanligtvis.
          </WordExplanation>
        </WordCardContainer>
        ...
        <WordCardContainer>
          ...
          <WordExplanation>
            Efterstygn kan sys på det stickade eller virkade plagget när det är
            färdigt.
          </WordExplanation>
        </WordCardContainer>
        ...
        <WordCardContainer>
          ...
          <WordExplanation>
            Förkortade varv formar plagget då man inte stickar över alla maskor
            på varvet varje gång. Plagget blir bredare på den sida där det
            stickas flest varv.
          </WordExplanation>
        </WordCardContainer>
        ...
        <WordCardContainer>
          ...
          <WordExplanation>
            När man stickar i den främre maskbågen är detta den bågen som är
            närmast dig, oavsett om du stickar från rät- eller avigsidan.
          </WordExplanation>
        </WordCardContainer>
      </LetterSection>
    </>
